...
using RKSoftware.Packages.ApiRequestValidation.SourceGenerator;
...
{
    private const string _directoryPath = "../../../../RKSoftware.Packages.ApiRequestValidation.Fakes";
...
";
    ...
    public async Task GenerationTest()
    {
        ...
        var generator = new ApiRequestValidationSourceGenerator();
